...
/**
 * Action for starting pump.
 */
@Log4j2
@Component
@RequiredArgsConstructor
@ConditionalOnMissingBean(MasterConfig.class)
public class PumpStartAction extends Action<Pump, Void> {
    ...
    protected Void doAction(ActionDto actionDto, Pump pump) {
        log.info("Starting pump: {}", pump.getName());
        service.toggleOn(pump.getPin());
