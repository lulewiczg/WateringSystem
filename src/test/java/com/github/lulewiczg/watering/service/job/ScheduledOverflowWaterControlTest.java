...
class ScheduledOverflowWaterControlTest {
    ...
    void testOverflowOk(SystemStatus status, int minLevel, int maxLevel, int level) {
        ...
        Sensor sensor = new Sensor(minLevel, maxLevel, level, RaspiPin.GPIO_01);
        Tank tank = new Tank(100, sensor, valve);
    ...
    void testOverflow(SystemStatus status, int minLevel, int maxLevel, int level) {
        ...
        Sensor sensor = new Sensor(minLevel, maxLevel, level, RaspiPin.GPIO_01);
        Tank tank = new Tank(100, sensor, valve);
        Valve valve2 = new Valve("valve2", ValveType.OUTPUT, true, RaspiPin.GPIO_02);
        Sensor sensor2 = new Sensor(1, 3, 2, RaspiPin.GPIO_03);
        Tank tank2 = new Tank(100, sensor2, valve2);
