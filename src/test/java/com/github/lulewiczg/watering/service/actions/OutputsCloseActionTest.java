...
//
//        verify(closeAction).doAction(argThat(i -> i.getId() != null), eq(valve));
//        verify(closeAction).doAction(argThat(i -> i.getId() != null), eq(valve2));
...
//        when(closeAction.doAction(eq(nestedDto), any())).thenCallRealMethod();
//
//        ActionResultDto<Void> result = action.doAction(actionDto, null);
//
//        verify(closeAction).doAction(nestedDto, valve);
//        verify(closeAction).doAction(nestedDto, valve2);
