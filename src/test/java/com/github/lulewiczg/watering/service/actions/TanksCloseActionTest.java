...
//
//        verify(closeAction).doAction(argThat(i -> i.getId() != null), eq(valve3));
...
//        verify(closeAction, never()).doAction(argThat(i -> i.getId() != null), eq(valve4));
