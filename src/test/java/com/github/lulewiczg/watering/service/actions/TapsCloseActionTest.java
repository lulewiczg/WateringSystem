...
//        when(closeAction.doAction(argThat(i -> i.getId() != null), any())).thenCallRealMethod();
//        ActionDto actionDto = new ActionDto();
//
//        ActionResultDto<Void> result = action.doAction(actionDto, null);
//
//        verify(closeAction).doAction(argThat(i -> i.getId() != null), eq(valve4));
//        verify(closeAction, never()).doAction(argThat(i -> i.getId() != null), eq(valve));
//        verify(closeAction, never()).doAction(argThat(i -> i.getId() != null), eq(valve2));
//        verify(closeAction, never()).doAction(argThat(i -> i.getId() != null), eq(valve3));
...
//        when(closeAction.doAction(nestedDto, null)).thenCallRealMethod();
//
//        ActionResultDto<Void> result = action.doAction(actionDto, null);
//
//        verify(closeAction).doAction(nestedDto, valve4);
//        verify(closeAction, never()).doAction(nestedDto, valve);
//        verify(closeAction, never()).doAction(nestedDto, valve2);
//        verify(closeAction, never()).doAction(nestedDto, valve3);
//        TestUtils.testActionResult(result);
