...
@SpringBootTest
@TestPropertySource(locations = {"classpath:application-test.properties", "classpath:application-testSlave.properties"})
class AppConfigAutoLoadSlaveTest {
    ...
    void testPropsLoad() {
        ...
        WaterLevelSensorConfig sensor = new WaterLevelSensorConfig("sensor1", 12, 21, "GPIO 1");
        WaterLevelSensorConfig sensor2 = new WaterLevelSensorConfig("sensor2", 99, 100, "GPIO 2");
