...
class AppConfigAutoLoadTest {
    ...
    void testPropsLoad() {
        ...
        ValveConfig valve = new ValveConfig("Tank 1", ValveType.INPUT, false);
        ValveConfig valve2 = new ValveConfig("Tank 2", ValveType.INPUT, false);
        ValveConfig valve3 = new ValveConfig("tap water", ValveType.INPUT, false);
        ValveConfig valve4 = new ValveConfig("out", ValveType.OUTPUT, true);
        ...
        WaterLevelSensorConfig sensor = new WaterLevelSensorConfig(12, 21);
        WaterLevelSensorConfig sensor2 = new WaterLevelSensorConfig(99, 100);
